...
40.times do
    ...
    Attachment.create!(repository_id: Faker::Number.within(range: 1..20), user_id: Faker::Number.within(range: 1..10), name: Faker::App.name, code: Faker::Lorem.sentences(number: 2))
